"""Authenticated, user-controlled long-term-memory API."""
...
from service.auth import CurrentUser, require_current_user
from service.memory import (MemoryCandidate, MemoryItem, MemoryStatus,
