...
import { MultiplaneHero } from "./MultiplaneHero";

type Filter = "offmodel" | "unsure" | "pass" | "all" | "needs_key";

export function ReviewWorkbench({ log, result, running, keyUrls, verdicts, onVerdict, onRefill, compareSlot, fps, initialFocus }: {
  log: PairEvent[];
