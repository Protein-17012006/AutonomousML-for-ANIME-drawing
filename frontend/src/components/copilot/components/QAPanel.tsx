...
import { ARC, abstainZone, clamp01, statusClass, statusGlyph } from "../lib/pairView";
import { errTypeLabel, qaLabel, readableReason, regionLabel } from "../labels";

export function QAPanel({ p, band, ex }: { p: PairEvent | null; band?: CsqBand | null; ex?: Explanation }) {
